...
public class Selenium4Test {
  ...
  void checkChromeInGrid2() throws MalformedURLException {
    RemoteWebDriver rd = new RemoteWebDriver(new URL("http://localhost:2222/wd/hub"), new ChromeOptions());
  ...
  void checkChromeInGrid3() throws MalformedURLException {
    RemoteWebDriver rd = new RemoteWebDriver(new URL("http://localhost:3333/wd/hub"), new ChromeOptions());
    rd.setFileDetector(new LocalFileDetector());
    driver = rd;
    clickAndCheck();
  }
  ...
  void checkChromeInGrid4() throws MalformedURLException {
    RemoteWebDriver rd = new RemoteWebDriver(new URL("http://localhost:4444/wd/hub"), new ChromeOptions());
    rd.setFileDetector(new LocalFileDetector());
    driver = rd;
    clickAndCheck();
  }
